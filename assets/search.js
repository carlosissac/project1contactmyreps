$(document).ready(function() {
    ...
    var addressValition = function() {
        ...
        if($("#search-address1").val() === "") {
            ...
            $("#address1").text("Address one is required");
        ...
        if($("#search-city").val() === "") {
            ...
            $("#citySearch").val("required");
            $("#citySearch").css("color", "red");
        }
        else {
            console.log("TEEEEEEXT INPUT IS OK");
        }
        ...
        if($("#search-zipcode").val() === "") {
            console.log("zip INPUT IS EMPTY");
            $("#zipCode").val("required");
